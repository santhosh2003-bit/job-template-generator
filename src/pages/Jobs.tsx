  ...
  const jobs = [
    {
      ...
      matchPercentage: 96,
      description:
        "We are looking for a Senior Frontend Developer who is proficient with React.js. The ideal candidate should have experience building scalable web applications, optimizing performance, and implementing responsive designs.",
      requirements: [
    ...
    },
    {
      ...
      matchPercentage: 92,
      description:
        "We're seeking a talented Full Stack Engineer to join our growing team. The ideal candidate will work on both frontend and backend development, implement new features, and maintain existing ones.",
      requirements: [
    ...
    },
    {
      ...
      matchPercentage: 89,
      description:
        "DigitalCraft is looking for a Frontend Developer to join our team. You will be responsible for implementing visual elements and UI components that users interact with.",
      requirements: [
    ...
    },
    {
      ...
      matchPercentage: 85,
      description:
        "Join our mobile development team to build cross-platform applications using React Native. You'll be working on cutting-edge mobile applications for our clients.",
      requirements: [
    ...
    },
    {
      ...
      matchPercentage: 82,
      description:
        "CloudSync is seeking a Frontend Engineer to help build our next-generation cloud management dashboard. You'll be working closely with designers and backend engineers.",
      requirements: [
    ...
    },
    {
      ...
      matchPercentage: 78,
      description:
        "DesignFirst is looking for a UI/UX Developer who can bridge the gap between design and implementation. You'll work on creating beautiful, functional interfaces for our clients.",
      requirements: [
      ...
      <div className="max-w-6xl mx-auto mt-20">
        ...
        >
          ...
          <p className="text-muted-foreground mt-2">
            We've matched your resume with jobs that fit your skills and
            experience.
          </p>
        </motion.div>
