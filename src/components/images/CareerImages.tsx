...
const CareerImages: FC<CareerImageProps> = ({ 
  ...
  // Fixed image URLs (using absolute URLs from Unsplash)
  const imagesByCategory = {
    tech: [
      "https://images.unsplash.com/photo-1581089781785-603411fa81e5?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1573164574572-cb89e39749b4?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1200&auto=format&fit=crop",
    ],
    design: [
      "https://images.unsplash.com/photo-1613909207039-6b173b755cc1?q=80&w=1200&auto=format&fit=crop",
    ...
    marketing: [
      "https://images.unsplash.com/photo-1533750516280-125c550b92d3?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1200&auto=format&fit=crop",
    ],
    business: [
      "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1573164574001-518958d9baa2?q=80&w=1200&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1664575600796-ffa828c5cb6e?q=80&w=1200&auto=format&fit=crop",
    ],
    general: [
  ...
  // Select a random image from the appropriate category with a stable seed
  const currentDay = new Date().getDate();
  const randomIndex = Math.abs(category.charCodeAt(0) + currentDay) % imagesByCategory[category].length;
